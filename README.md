...
*   **Finsights** (`finsights_agent`): Combines macro and micro insights to assist wealth managers in building winning portfolios.
    > [!NOTE]
    > The Finsights sub-agent is excluded from this open source release. Please contact the team if you would like to know more.
